  ...
  <div class="login-box-body">
    ...
    <form action="ServletLogin" method="Post">
      <div class="form-group has-feedback">
          <input type="text" name="txtNombreUsuario" id="txtUsu" value="" class="form-control"  placeholder="Usuario">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
          <input type="password" name="txtContra" id="txtPass" value="" class="form-control" placeholder="******">
