...
CREATE TABLE `movimientos` (
  ...
  `cuentas_idcuenta` int(11) NOT NULL,
  PRIMARY KEY (`idtransacion`,`cuentas_idcuenta`),
  KEY `fk_movimientos_tipomovimiento1_idx` (`idtipomovimiento`),
  KEY `fk_movimientos_cuentas1_idx` (`cuentas_idcuenta`),
  CONSTRAINT `fk_movimientos_cuentas1` FOREIGN KEY (`cuentas_idcuenta`) REFERENCES `cuentas` (`idcuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `prestamos` (
  ...
  `usuarios_dni` int(11) NOT NULL,
  `usuarios_usuario` varchar(45) NOT NULL,
  `numcuotas_pagas` int(11) DEFAULT NULL,
  PRIMARY KEY (`idprestamo`,`usuarios_dni`,`usuarios_usuario`),
  KEY `fk_prestamos_usuarios1_idx` (`usuarios_dni`,`usuarios_usuario`),
  CONSTRAINT `fk_prestamos_usuarios1` FOREIGN KEY (`usuarios_dni`, `usuarios_usuario`) REFERENCES `usuarios` (`dni`, `usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'bdbancoint'
--

--
-- Dumping routines for database 'bdbancoint'
--
